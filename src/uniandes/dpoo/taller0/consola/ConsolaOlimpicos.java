...
public class ConsolaOlimpicos
{
	...
	private void ejecutarMejorPaisEnUnEvento()
		...
		if (mejores.size() == 0)
			...
			System.out.println("Ha gando: " + medallas[0] + " oros, " + medallas[1] + " platas, " + medallas[2] + " bronces.");}
		else
			{
			...
			for (Map.Entry<String, int[]> entry : mejores.entrySet())
				...
				System.out.println(entry.getKey() + "ha gando: " + 
						medallas[0] + " oros, " +
						medallas[1] + " platas, "+
						medallas[2] + " bronces.");}
			}
	...
	private void ejecutarAtletasConMasMedallasQue()
		...
		try 
			...
			System.out.println("Hay " + atletas.size() + " atletas que han ganado más de " + cantidadMinima + " medallas.");
